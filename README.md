...
Analisar a complexidade de algoritmos de ordenação e busca através do monitoramento do tempo de execução de cada um deles.

## Diretório e Arquivos
.
├── main.cpp          # Arquivo principal
├── mergesort.cpp     # Implementação do algoritmo Merge Sort
├── vetores.cpp       # Funções auxiliares para vetores
